...
# res = requests.get("https://uno.ma/iphone-maroc/iphone-8-plus-maroc/")
res = requests.get("https://uno.ma/iphone-maroc/iphone-8-plus-maroc/?limit=100")
html = res.text
...
cards_links = list()
stockage_list = ['128 Gb','256 Gb','512 Gb','1 Tb' ,'128 Go','256 Go','512 Go','1 To' , '64 Go' , '64 Gb' ]
    ...
    for num, ic in enumerate(items_cards):
        ...
        try:
            ...
            if(len(myresult) == 0):
                ...
                val = ("iPhone 8 Plus",item_title, item_link, 1, 1, jsonStringify, "", image_item, item_price,scraped_at)
                mycursor.execute(sql, val)
                print("id = {}".format(
                    mycursor.lastrowid
                ))
