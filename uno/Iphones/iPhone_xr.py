...
# res = requests.get("https://uno.ma/iphone-maroc/iphone-xr-maroc/")
res = requests.get("https://uno.ma/iphone-maroc/iphone-xr-maroc/?limit=100")
html = res.text
    ...
    for num, ic in enumerate(items_cards):
        ...
        try:
            ...
            if(len(myresult) == 0):
                ...
                val = ("iPhone Xr", item_title, item_link, 1, 1, item_color, item_stockage, "", image_item, item_price,scraped_at)
                mycursor.execute(sql, val)
                print("id = {}".format(
                    mycursor.lastrowid
                ))
