...
def get_bricoma_products():
    ...
    sql = """SELECT * FROM ITEMS WHERE id_store = 5
        and (
        category_in_store = 'Pompe'
        or category_in_store = 'Alimentation animalerie'
        or category_in_store = 'Fontaines et Osmoseurs'
        or category_in_store = 'Coffres forts'
        or category_in_store = 'Luminaires decoratifs'
        or category_in_store = 'Poubelle Industrielle'
        )
    ;"""
