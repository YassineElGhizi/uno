...
#Helpers
from iris_helpers import get_category_id_iris, get_iris_products
...
url_post = "http://127.0.0.1:9999/products?website=iris"
...
def main(brands : List) -> List:
    ...
    for r in results:
        ...
        tmp_d["category_in_store_to_id"] = get_category_id_iris(r["category_in_store"])
        tmp_d["link"] = r["link"]
